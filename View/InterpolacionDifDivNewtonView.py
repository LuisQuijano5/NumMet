...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Interpolacion Diferencias Divididas')
        ...
        # Label de Metodo
        label_opcion = QtWidgets.QLabel("Interpolacion Diferencias Divididas")
        ...
        layout_renglones.addWidget(label_x)
        self.edit_X = QtWidgets.QLineEdit()
        int_validator = QtGui.QIntValidator(1, 1000, self)
        self.edit_X.setValidator(int_validator)
        layout_renglones.addWidget(self.edit_X)
